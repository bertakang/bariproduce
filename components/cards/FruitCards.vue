        ...
        <div class="card-wrapper">
          <div class="wrapper">
            ...
            <div class="card-image">
              <NuxtImg format="webp" :src="`https://bertakang.pythonanywhere.com/mysite/${card.file_path}`" :alt='card.name' style="width: 100%; height: auto; object-fit: cover; align-self:flex-end;" />
            </div>
